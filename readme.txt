...
1. Upload `weather-forecast-shortcode` folder to the `/wp-content/plugins/` folder
...
Weather forecast from yr.no shortcode 
...
1. Upload `yr` folder to the `/wp-content/plugins/` folder
1. Activate the plugin through the 'Plugins' menu in WordPress
...
Visit [yr.no] (http://www.yr.no) and search for your place. Copy the url.

* [yr url="http://www.yr.no/place/Norway/Oslo/Oslo/Oslo" name="Oslo"]
* [yr url="http://www.yr.no/place/United_States/New_York/Times_Square~5141023" name="Times Square"]
* [yr url="http://www.yr.no/sted/Thailand/Krabi/Ao_Nang" name="Ao Nang"]
